...
<style>
    ...
    <section id="main-content">
      <section class="wrapper" id="lec_plan">
        <div class="col-md-12">
          <h3><i class="fa fa-angle-right"></i>학기별강의목록/등록</h3>
          <!-- page start-->
        ...
        <div class="row">
          ...
          <td>
          <button class="btn btn-small btn-theme" style="float:right;">기본강의등록</button>
          <button class="btn btn-small btn-theme" style="margin-right:5px; float:right;">학기강의등록</button>
