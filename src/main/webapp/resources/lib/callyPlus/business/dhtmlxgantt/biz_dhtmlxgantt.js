...
! function(t) {
        ...
        _prepareScaleHtml: function(t, e, i) {
            ...
            for (var u = c; u < h && t.trace_x[u]; u++) {
                ...
                var _ = o.call(this, s),
                    ...
                    k = "";
                if (f) {
                    v = "width:" + f + "px;height:" + g + "px;" + (n.smart_scales ? "position:absolute;left:" + p + "px" : ""), k = "gantt_scale_cell" + (u == t.count - 1 ? " gantt_last_cell" : ""), (m = d.call(this, s)) && (k += " " + m);
                    var y = "<div class='" + k + "'" + this.$gantt._waiAria.getTimelineCellAttr(_) + " style='" + v + "'>" + _ + "</div>";
                    a.push(y)
                }
            }
            return a.join("")
    ...
    t.exports = function(t) {
        var e = i(18);
        t.assert = i(29)(t), t.init = function(e, i, r) {
            var a;
    ...
    t.exports = function(t) {
        ...
        return n(r, e), r.prototype.render = function(e) {
            ...
            g[0].onclick = t.bind(function() {
                ...
                var i;
                return (i = (e = e || window.event).charCode || e.keyCode || e.which) == t.constants.KEY_CODES.DOWN ? (k(-1 * t.config.duration_step), !1) : i == t.constants.KEY_CODES.UP ? (k(1 * t.config.duration_step), !1) : void window.setTimeout(m, 1)
    ...
    t.exports = function(t) {
        ...
        function p() {
            ...
            var e = n.getNodePosition(h()),
                ...
                y = _.inner_width,
                b = _.width;
            l && !p ? l = 0 : l < 0 && !g ? l = 0 : l > 0 && g + p >= m + 2 && (l = 0), s && !y ? s = 0 : s < 0 && !k ? s = 0 : s > 0 && k + y >= b && (s = 0);
        ...
        r = function(t, e) {
            ...
            u.attachEvent("onBeforeDragStart", e.bind(function(i, r) {
                ...
                var h = !!n.locateClassName(o, "gantt_link_control"),
                    ...
                    k = e.locate(o),
                    y = !0;
                if (h && (y = !n.locateClassName(o, "task_end_date"), h = !!k), r = k, i = h, a = y, h) {
                    var b = e.getTask(k),
                        $ = t.$getConfig(),
                ...
                var S = !(v == h && g == k && m == y);
                return S && (g && e.refreshTask(g, !1), k && e.refreshTask(k, !1)), S && f(d.marker),
                    function(i, n, r, a) {
                        var s = function() {
                        ...
                        var f = Math.sin(_),
                            ...
                            v = Math.round(n),
                            m = Math.round(i),
                            k = ["-webkit-transform: rotate(" + _ + "rad)", "-moz-transform: rotate(" + _ + "rad)", "-ms-transform: rotate(" + _ + "rad)", "-o-transform: rotate(" + _ + "rad)", "transform: rotate(" + _ + "rad)", "width:" + Math.round(c) + "px"];
                        if (-1 != window.navigator.userAgent.indexOf("MSIE 8.0")) {
                            k.push('-ms-filter: "' + function(t, e) {
            ...
            if (e.$config.bind && t.getDatastore(e.$config.bind)) {
                ...
                t.defined(e.$getConfig().dnd_sensitivity) && (r.config.sensitivity = e.$getConfig().dnd_sensitivity), r.attachEvent("onBeforeDragStart", t.bind(function(i, n) {
                    ...
                    if (l.exists(h) || (h = r.lastTaskOfLevel(o.order_branch_free ? d.$level : 0)) == r.config.id && (h = null), l.exists(h)) {
                        ...
                        for (var v = l.getIdByIndex(f - 1), m = l.getItem(v), k = 1;
                            (!m || m.id == _.id) && f - k >= 0;) v = l.getIdByIndex(f - k), m = l.getItem(v), k++;
                        if (d.id == _.id) return;
            ...
            return {
                onCreated: function(e) {
                    e.$config = n.mixin(e.$config, {
                        bind: "task"
                    }), "grid" == e.$config.id && (this.extendGantt(e), t.ext.inlineEditors = t.ext._inlineEditors.createEditors(e), t.ext.inlineEditors.init()), this._mouseDelegates = i(9)(t)
                },
                onInitialized: function(e) {
        ...
        return function(e, i) {
            ...
            for (var l = [], d = 0; d < r.length; d++) {
                var c, h, u, _ = d == r.length - 1,
                    f = r[d];
                "add" == f.name ? (h = "<div " + (k = t._waiAria.gridAddButtonAttrString(f)) + " class='gantt_add'></div>", u = "") : (h = f.template ? f.template(e) : e[f.name], n.isDate(h) && (h = s.date_grid(h, e)), u = h, h = "<div class='gantt_tree_content'>" + h + "</div>");
                ...
                var k = t._waiAria.gridCellAttrString(f, u);
                p.push(h), a.rtl && (p = p.reverse()), c = "<div class='" + g + "' data-column-index='" + d + "' data-column-name='" + f.name + "' style='" + m + "' " + k + ">" + p.join("") + "</div>", l.push(c)
            }
            if (g = t.getGlobalTaskIndex(e.id) % 2 == 0 ? "" : " odd", g += e.$transparent ? " gantt_transparent" : "", g += e.$dataprocessor_class ? " " + e.$dataprocessor_class : "", s.grid_row_class) {
                var y = s.grid_row_class.call(t, e.start_date, e.end_date, e);
                y && (g += " " + y)
            }
    ...
    i(13), t.exports = function() {
        var t = new function() {
            this.constants = i(125), this.version = "5.2.0", this.templates = {}, this.ext = {}, this.keys = {
                edit_save: this.constants.KEY_CODES.ENTER,
                edit_cancel: this.constants.KEY_CODES.ESC
            }
        };
        i(124)(t), t.$services = t.$inject(i(123)), t.config = t.$inject(i(122)), t.ajax = i(121)(t), t.date = i(120)(t);
        var e = i(119)(t);
        ...
        var a = i(0);
        a.mixin(t, a), t.env = i(11);
        var s = i(26)();
        t.event = s.attach, t.eventRemove = s.detach, t._eventRemoveAll = s.detachAll, t._createDomEventScope = s.extend, a.mixin(t, i(116)(t));
        var o = i(115).init(t);
        ...
        var l = i(83);
        return t.mixin(t, l()), i(82)(t), i(75)(t), i(72)(t), i(63)(t), i(62)(t), i(61)(t), i(60)(t), i(59)(t), i(58)(t), i(51)(t), i(50)(t), i(42)(t), i(41)(t), i(40)(t), i(39)(t), i(38)(t), i(37)(t), i(36)(t), i(35)(t), i(34)(t), i(33)(t), i(32)(t), i(31)(t), i(14)(t), i(30)(t), i(28)(t), t
    }
}, function(t, e) {
    t.exports = function(t) {
        function e(e, i) {
