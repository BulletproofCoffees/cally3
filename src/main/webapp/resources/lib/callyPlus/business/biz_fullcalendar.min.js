        ...
        function f(u) {
            ...
            (u = b.header[u]) && m.each(u.split(" "), function(oa) {
                ...
                m.each(this.split(","), function(ra, sa) {
                    if (sa == "title") {
                        fa.append("<span class='fc-header-title' style='color:#646464'><h2>&nbsp;</h2></span>");
    ...
    function sb(a, b, e) {
        ...
        function g(w,
            ...
            for (aa = 0; aa < w; aa++) {
                ...
                for (V = 0; V < F; V++) R += "<td class='fc- " + ea + " fc-day" + (aa * F + V) + "' onClick='javascript:business_goAddForm(this)'><div>" + (I ? "<div class='fc-day-number'/>" : "") + "<div class='fc-day-content'><div style='position:relative'>&nbsp;</div></div></div></td>";
                R += "</tr>"
            }
            R += "</tbody></table>";
            w =
