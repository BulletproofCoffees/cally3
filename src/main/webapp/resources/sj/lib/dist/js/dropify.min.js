...
! function(e, i) {
    ...
    if($("input.myimg").attr('value') != null){
    	/*alert($("input.myimg").attr('value'));*/
    	  function i(i, t) {
    	        ...
    	        if (window.File && window.FileReader && window.FileList && window.Blob) {
    	            var s = {
    	                ...
    	                maxFileSize: 0,
    	                messages: {
    	                	 "default":'<div class="dropify-preview" style="display: block;"><span class="dropify-render"><img src="'+$("input.myimg").attr('value')+'"></span></div>'        
    	                	
    	                    	
    	                },
    	                tpl: {
    	                    wrap: '<div class="dropify-wrapper"></div>',
    	                    message: '<div class=""><span class="file-icon" /> <p>{{ default }}</p></div>',
    	                    preview: '<div class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-infos-message">{{ replace }}</p></div></div></div>',
    	                    filename: '<p class="dropify-filename"><span class="file-icon"></span> <span class="dropify-filename-inner"></span></p>',
    	                    clearButton: '<button type="button" class="dropify-clear">취소</button>',
    	        ...
    	        if (window.File && window.FileReader && window.FileList && window.Blob) {
    	            var s = {
    	                ...
    	                tpl: {
    	                    ...
    	                    preview: '<div class="dropify-preview"><span class="dropify-render"></span><div class="dropify-infos"><div class="dropify-infos-inner"><p class="dropify-infos-message">{{ replace }}</p></div></div></div>',
    	                    filename: '<p class="dropify-filename"><span class="file-icon"></span> <span class="dropify-filename-inner"></span></p>',
    	                    clearButton: '<button type="button" class="dropify-clear">등록하기</button>',
    	                    error: '<p class="dropify-error">{{ error }}</p>'
    	                }
    ...
    return i.prototype.onChange = function() {
     ...
     /*   alert($("div.dropify-wrapper").html());
        
        $("div.dropify-wrapper").empty();
        $("div.dropify-message").append('<img id="foo" alt="" src="" class="col-md-12" >');*/
       ...
       /* alert($("p.dropify-infos-message").html());*/
